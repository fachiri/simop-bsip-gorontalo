			...
			<div class="card">
				<div class="card-header d-flex justify-content-between align-items-center">
					...
					<div class="d-flex gap-2">
						<a href="{{ route('dashboard.master.pics.edit', $user->uuid) }}" class="btn btn-success btn-sm">
							<i class="bi bi-pencil-square"></i>
							Edit
						</a>
						<x-modal.delete :id="'deleteModal-'. $user->uuid" :route="route('dashboard.master.pics.destroy', $user->uuid)" :data="$user->name" text="Hapus" />
					</div>
				</div>
